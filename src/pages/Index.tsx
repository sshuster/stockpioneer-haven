  ...
  React.useEffect(() => {
    const fetchMarketData = async () => {
      try {
        ...
        setMarketData(data.slice(0, 4)); // Just get first 4 for showcase
      } catch (error) {
      ...
      <section className="py-20 px-8">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold mb-4">Why Choose StockPioneer?</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Our platform combines elegant design with powerful functionality to give you the ultimate trading experience.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="text-center p-6 rounded-lg">
              ...
              <p className="text-muted-foreground">
                Access real-time market data and performance insights to make informed decisions instantly.
              </p>
            </div>
      ...
      <section className="py-20 px-8">
        <div className="container mx-auto text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
            Join thousands of traders who have already discovered the StockPioneer advantage.
          </p>
      ...
      <footer className="py-12 px-8 bg-slate-900 text-white">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">StockPioneer</h3>
              <p className="text-slate-400">
                Transforming the way you trade with cutting-edge technology and elegant design.
              </p>
            </div>
          ...
          <div className="border-t border-slate-800 mt-12 pt-8 text-center text-slate-400">
            <p>© {new Date().getFullYear()} StockPioneer. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
